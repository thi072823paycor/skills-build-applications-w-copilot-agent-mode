...
async function seedDatabase() {
    try {
        ...
        await Promise.all([
            octofit_1.User.deleteMany({}),
            octofit_1.Team.deleteMany({}),
            octofit_1.Activity.deleteMany({}),
            octofit_1.LeaderboardEntry.deleteMany({}),
            octofit_1.Workout.deleteMany({}),
        ]);
        await Promise.all([
            octofit_1.User.insertMany(users),
            octofit_1.Team.insertMany(teams),
            octofit_1.Activity.insertMany(activities),
            octofit_1.LeaderboardEntry.insertMany(leaderboard),
            octofit_1.Workout.insertMany(workouts),
        ]);
